...
// $user_id = wp_create_user( 'jai', 'jai', 'jai@gmail.com' );
// $user_id_role = new WP_User($user_id);
// $user_id_role->set_role('psp_project_manager');
  ...
  <body>
	<section class="registeration">
		...
		<div class="col-md-12" style="margin-top:15px;">
			...
			<a href="<?php echo home_url();?>/user-login" class="btn btn-danger btn-login pull-right" style="margin-top: 14px;background-color: #e00719;">Login</a>
		</div>
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
								...
								<div class="form-group has-success has-feedback">
								  ...
								  <input type="text" name="username" class="form-control" id="get_username" required onkeyup = "checkusername(this.value);" aria-describedby="inputSuccess2Status" placeholder="Keep it Simple! Enter your keyword code" />
