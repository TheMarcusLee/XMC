...
<html lang="en">
  ...
  <body>
	<section class="capture-one full-height" style="background:url(<?php echo  get_template_directory_uri().'-child'; ?>/img/nature1.jpg);background-size:cover;">
		<div class="container">
			<div class="capture-box">
				<h3>Earn $1250 a Day</h3>
				<h5>Enter You Info Below To Learn How Xtremely Simple It Is</h5>
				<h5>Join Now To Start Making True Residual Income</h5>
				<form method="post">
        <div class="form-group">
					...
					<button type="submit" class="btn btn-block btnCapture" name="submit">Join Now</button>
				</form>
			</div>
		</div>
	</section>
