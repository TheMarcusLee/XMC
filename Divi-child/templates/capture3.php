...
<html lang="en">
  ...
  <body>
	<section class="capture-one capture-three full-height" style="background:url(<?php echo  get_template_directory_uri().'-child'; ?>/img/beach-fishing.jpg);background-size:cover;">
		<div class="container">
			<div class="capture-box">
				<h1> Discover My Xtremely Simple Blueprint That Has Taken Me From A 40 Hour Work Week To A Work ON MY Terms Work Week!</h1>
				<h6>Generating TRUE Residual <br /> Income!</h6>
				<h6>Get Access Below TO this XTREMELY Simple</h6>
				<h6>System!</h6>
				<form class="capture-three-form" method="post">
					...
					<button type="submit" class="btnInstant" name="submit">
						<img src="<?php echo  get_template_directory_uri().'-child'; ?>/img/get-instant-access-btn.png" alt="..." />
					</button>
				</form>
			</div>
		</div>
