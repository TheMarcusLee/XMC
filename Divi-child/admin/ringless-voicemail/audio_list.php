...
if(paidStatus($user_id)->tier2_status == 0) { 
    ...
    if($audio_list[extension] == 'wav' || $audio_list[extension] == 'mp3' || $audio_list[extension] == 'm4a')
    {
        ...
        echo '<script>alert("Upload .WAV, .MP3 or .M4A Files Only. Files Must Be Less Than 10MB. format audio only");</script>';
    }
}
                                    ...
                                    ?>
										<tr>
											...
											<td>
                                             ...
                                             <a href="<?php echo get_template_directory_uri().'-child/admin/ringless-voicemail/audio_files/'.$data['audio_file'];?>" download class="btn btn-warning"> <i class="fa fa-cloud-download"></i></a>
