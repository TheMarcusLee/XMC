...
if(isset($_POST['svb_name'])){
    ...
    $wpdb->insert($table_name,$data);
		echo '<script>window.location.href="'.home_url().'/dashboard/?page=sms_voice_broadcast&sms_page=subscriber";</script>';
													  ...
													  <div class="form-group">
														<div class="col-sm-12 text-left">
														  <button type="submit" class="btn btn-primary previewBtn"><i class="fa fa-floppy-o"></i> Save</button>
																<a href="<?php echo home_url();?>/dashboard/?page=sms_voice_broadcast&sms_page=subscriber" class="btn btn-danger"> <i class="fa fa-times"></i>  Cancel</a>
															</div>
													  </div>
													  </form>
													</div>
