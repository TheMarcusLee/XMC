...
Reply STOP to cancel msgs';
    ...
    $wpdb->insert($recent_table,$data);
    echo '<script>window.location.href="'.home_url().'/dashboard/?page=sms_voice_broadcast&sms_page=recent_broad&imsg=1";</script>';
											...
											<div class="col-md-7 col-sm-12 col-lg-7 col-xs-12">
												<div class="profile-box">
													...
													<form class="form-horizontal profile-form" method="post">
													  ...
													  <div class="form-group">
														<!-- <label class="col-sm-8 col-md-8 col-lg-8 col-xs-12 control-label">Choose Number Pool or Phone Number(s) Manually  </label> -->
														<label class="col-sm-8 col-md-8 col-lg-8 col-xs-12 control-label"></label>
														<div class="col-sm-8 col-md-8 col-lg-8 col-xs-12">
														  <!-- <ul class="list-inline">
															<li>
																<label class="radio-inline">
																  <input type="radio" name="choose_no" id="choose_no1" value="0"  checked /> Manual Numbers
																</label>
															</li>
															<li>
																<label class="radio-inline">
																  <input type="radio" name="choose_no" id="choose_no2" value="1"  />  Numbers Pool
																</label>
															</li>
														  </ul> -->
													  ...
													  <div class="form-group">
														...
														<div class="form-group">
														<label class="col-sm-8 col-md-8 col-lg-8 col-xs-12 control-label">Enter Phone Numbers</label>
														<div class="col-sm-8 col-md-8 col-lg-8 col-xs-12">
															<textarea class="form-control" maxleength="" name="enter_phone_no" rows=5 id="sms_scampaign_sms"></textarea> 
													  ...
													  <div class="form-group">
														...
														<div class="col-sm-8 col-md-8 col-lg-8 col-xs-12">
															<textarea class="form-control" maxleength=160 name="sms_text" required id="sms_campaign_sms" rows=5></textarea>
