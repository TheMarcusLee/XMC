...
if(isset($_GET['row_id'])){
		$row_id = $_GET['row_id'];		
		$single = $wpdb->get_row("SELECT * FROM $table_name WHERE id=$row_id");    		
}
													...
													<form action="" method="post">
													  <div class="form-group">
														...
														<div class="col-sm-7 col-md-7 col-lg-7 col-xs-12">
														  <input type="text" name="svb_name"  class="form-control" value="<?php echo $single->name;?>"  />
														</div>
													  </div>
													  <div class="form-group">
														  ...
														  <select class="form-control"  name="svb_campaign">
															...
															<?php 
															  $sess_id  = $_SESSION['user_id'];
																...
																?>
																<option value="<?php echo $list->id;?>" <?php if($list->id == $single->campaign){ echo "selected"; } ?>><?php echo $list->title;?></option>
