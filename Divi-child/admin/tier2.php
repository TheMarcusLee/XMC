										...
										<div class="row">
											<div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
												<div class="profile-box link-boxes marketing-banners">
													<h3>Payment For Tier 2 Software</h3>
															 ...
															 <div class="col-md-4 col-sm-6 col-lg-4 col-xs-12 text-center">
                                                                ...
                                                                <div class="payment-box">
																	<ul class="">
																		...
																		<li><b>Amount<i>:</i></b><span>$200.00</span></li>
																		<li><b>Payment type<i>:</i></b><span>Tier 2 - One Time Payment</span></li>
																		<!-- <li><b>Last paid with<i>:</i></b><span>Paypal</span></li>
																		<li><b>Last paid on<i>:</i></b><span>3-Mar-2018</span></li> -->
																	</ul>
																	<?php if($refrer_detail->arb_login_key == "" && $refrer_detail->hmac_key == "" && $refrer_detail->paypal_email_id == "" ) { ?>
																		<div class="pay-know text-center"><a href="#" data-toggle="modal" data-target="#paymentMethod_tier2_full_admin">Pay Now</a></div>
																	<?php }else{ ?>
                                                                    	<div class="pay-know text-center"><a href="#" data-toggle="modal" data-target="#paymentMethod_tier2_full">Pay Now</a></div>
																	<?php } ?>
                                                                </div>
                                                            </div>
                                                            <!-- end first sales -->																																
															<?php }
                                                        elseif($refrer_detail->sales_ter2_count == 0) { ?>
                                                            <!-- for his/her first sales get 100% commision-->
                                                            <div class="col-md-4 col-sm-6 col-lg-4 col-xs-12 text-center">
                                                                <div class="payment-heading text-center"><h4>Payment</h4></div>
                                                                <div class="payment-box">
																	...
																	<?php if($refrer_detail->arb_login_key == "" && $refrer_detail->hmac_key == "" && $refrer_detail->paypal_email_id == "" ) { ?>
																		<div class="pay-know text-center"><a href="#" data-toggle="modal" data-target="#paymentMethod_tier2_admin">Pay Now</a></div>
																	<?php }else{ ?>
                                                                    	<div class="pay-know text-center"><a href="#" data-toggle="modal" data-target="#paymentMethod_tier2_full">Pay Now</a></div>
																	<?php } ?>
                                                                </div>
                                                            ...
                                                            <!-- end first sales -->
                                                    <?php }elseif($refrer_detail->sales_ter2_count == 1){ 
														if($refrer_name->paid_tier2_his == 0 ){ ?>
                                                        ...
                                                        <div class="col-md-4 col-sm-6 col-lg-4 col-xs-12 text-center">
                                                            ...
                                                            <div class="payment-box">
                                                                <ul class="">
                                                                    ...
                                                                    <li><b>Keyword<i>:</i></b><span><?php echo $his_refrer_detail->username; ?></span></li>
                                                                    <li><b>Amount<i>:</i></b><span>$150.00</span></li>
                                                                    <li><b>Payment type<i>:</i></b><span>Tier 2 - One Time Payment</span></li>
                                                                    <!-- <li><b>Last paid with<i>:</i></b><span>Paypal</span></li>
                                                                    <li><b>Last paid on<i>:</i></b><span>3-Mar-2018</span></li> -->
                                                                </ul>
																<?php if($refrer_detail->arb_login_key == "" && $refrer_detail->hmac_key == "" && $refrer_detail->paypal_email_id == "" ) { ?>
																		<div class="pay-know text-center"><a href="#" data-toggle="modal" data-target="#paymentMethod_tier2_admin">Pay Now</a></div>
																	<?php }else{ ?>
                                                                    	<div class="pay-know text-center"><a href="#" data-toggle="modal" data-target="#paymentMethod_tier2_his">Pay Now</a></div>
																	<?php } ?>
																<!-- <?php if($refrer_name->paid_tier2_referer == 0) {  ?>
                                                                	<div class="pay-know text-center"><a href="#" data-toggle="modal" data-target="#paymentMethod_tier2_my">Pay Now</a></div>
																<?php }else{ ?>
														...
														<div class="col-md-4 col-sm-6 col-lg-4 col-xs-12 text-center">
															...
															<div class="payment-box">
																<ul class="">
																    <li><b>Name</b><span><?php echo $admin_details->fname.' '.$admin_details->lname; ?></span></li>
																	<li><b>Keyword<i>:</i></b><span><?php echo $admin_details->username;?></span></li>
																	<li><b>Amount<i>:</i></b><span>$50.00</span></li>
                                                                    <li><b>Payment type<i>:</i></b><span>Tier 2 - One Time Payment</span></li>
																	<!-- <li><b>Last paid with<i>:</i></b> <span>Payzey</span></li>
																	<li><b>Last paid on<i>:</i></b><span>3-Mar-2018</span></li> -->
																</ul>
																<?php if($refrer_name->paid_tier2_admin == 0) {  ?>
																	<div class="pay-know text-center"><a href="#" data-toggle="modal" data-target="#paymentMethod_tier2_admin">Pay Now</a></div>																
																<?php }else{ ?>
													...
													<?php } ?>
                                                    <?php }elseif($refrer_detail->sales_ter2_count >= 2){                                                        
														if($refrer_name->paid_tier2_referer == 0 ){ ?>
                                                    <!-- for his/her third sales get 50% commision -->
                                                        <div class="col-md-4 col-sm-6 col-lg-4 col-xs-12 text-center">
                                                            ...
                                                            <div class="payment-box">
                                                                <ul class="">
																    <li><b>Name</b><span><?php echo $refrer_detail->fname.' '.$refrer_detail->lname; ?></span></li>
                                                                    <li><b>Keyword<i>:</i></b><span><?php echo $refrer_name->refrencename; ?></span></li>
                                                                    <li><b>Amount<i>:</i></b><span>$100.00</span></li>
                                                                    <li><b>Payment type<i>:</i></b><span>Tier 2 - One Time Payment</span></li>
                                                                    <!-- <li><b>Last paid with<i>:</i></b><span>Paypal</span></li>
                                                                    <li><b>Last paid on<i>:</i></b><span>3-Mar-2018</span></li> -->
                                                                </ul>
														...
														<?php }elseif($refrer_name->paid_tier2_his == 0){ 
                                                        ...
                                                        <div class="col-md-4 col-sm-6 col-lg-4 col-xs-12 text-center">
                                                            ...
                                                            <div class="payment-box">
																...
																<?php if($refrer_name->paid_tier2_his == 0) {  ?>
                                                                	<div class="pay-know text-center"><a href="#" data-toggle="modal" data-target="#paymentMethod_tier2_his_half">Pay Now</a></div>
																<?php }else{ ?>
                                                                	<div class="pay-know text-center">Paid to <?php echo $his_refrer_detail->fname.' '.$his_refrer_detail->lname; ?></a></div>
																<?php } ?>                                                                
                                                            </div>
...
<div class="modal fade" id="paymentMethod_tier2_full_admin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="payment-popup">
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="panel-heading" role="tab" id="headingOne">
					...
					<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOnetier2fulladmin" aria-expanded="true" aria-controls="collapseOnetier2">
				...
				<div id="collapseOnetier2fulladmin" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
					<form action="<?php echo home_url();?>/dashboard/?page=tier2&payment=authorize&role=admin" method="post" id="all_auth_form">
					<div class="row">
					...
					<div class="row">
						<div class="col-md-5 col-sm-5 col-lg-5 col-xs-12">
							<div class="form-group">
								...
								<!-- sucecess url -->
								<input name="return" value="<?php echo home_url();?>/dashboard?page=paypal_success&software=tier2&role=admin&referer=<?php echo $admin_details->username;?>&amount=20" type="hidden">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="amount_1" value="200.00" type="text" readonly class="form-control" placeholder="Amount" />
                                    </div>
                                </div>
                                </div>
									</br>
				...
				<div id="collapseThree1fulladmin" class="panel-collapse collapse <?php if($admin_details->arb_login_key == "" && $admin_details->paypal_email_id == ""){ echo "in"; }?>" role="tabpanel" aria-labelledby="headingThree">
					<div class="panel-body">
					<form action="<?php echo home_url();?>/dashboard/?page=tier2&payment=payeezy&role=admin" method="post" id="payeezy_all">
					<div class="row">
						<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
							<div class="form-group">
						...
						<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
							<div class="form-group">
							<label for="exampleInputEmail1">Amount to be paid</label>
								<input type="text" class="form-control" name="amount" placeholder="200" readonly value="$200">								
								<input type="hidden" name="referer" value="<?php echo $admin_details->username;?>">
							</div>
						</div>
				...
				<?php } 
				if($admin_details->stripe_secret != '') { ?>
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingThree">
							<h4 class="panel-title">
							<label for='r13' style='width: 100%;margin-bottom:0px;'>
							  	...
							  	<div class="row">	
									<form action="<?php echo home_url();?>/dashboard/?page=tier1&payment=stripe&role=admin" method="post">
										<script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
												...
												data-description="Access for a Tier 2"
												data-amount="20000"
												data-locale="auto"></script>
												<input type="hidden" class="form-control" name="amount" placeholder="40" readonly value="200">
												<input type="hidden" name="software" value="tier2">
												<input type="hidden" name="referer" value="<?php echo $admin_details->username;?>">
									</form>					
								</div>					
				...
				<?php } 
				if($admin_details->arb_login_key == null && $admin_details->paypal_email_id == null ){ echo "<h4 class='text-center' style='color:red;'>No Payment is selected from ".ucwords($admin_details->username)."</h4>"; ?>
...
<div class="modal fade" id="paymentMethod_tier2_full" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		...
		<div class="payment-popup">
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="panel-heading" role="tab" id="headingOne">
					...
					<label for='r11' style='width: 100%;margin-bottom:0px;'>
					<!--  <input type='radio' id='r11' name='occupation' value='Working' checked required /> -->
					<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOnetier2" aria-expanded="true" aria-controls="collapseOnetier2">
						Authorize.net <span class="payment-image pull-right"><img src="<?php echo home_url().'/wp-content/themes/Divi-child/admin/profile_image/'?>visa.png" alt="Visa" /> <img src="<?php echo home_url().'/wp-content/themes/Divi-child/admin/profile_image/'?>mastercard.png" alt="Visa" /></span>
					</a>
					</h4>
				</div>
				<div id="collapseOnetier2" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
					<form action="<?php echo home_url();?>/dashboard/?page=tier2&payment=authorize" method="post" id="all_auth_form">
					<div class="row">
						<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
							<div class="form-group">
								<label for="cardNumber">Card Number</label>
					...
					<div class="row">
						<div class="col-md-5 col-sm-5 col-lg-5 col-xs-12">
							<div class="form-group">
								...
								<input name="no_shipping" value="1" type="hidden">
								<!-- sucecess url -->
								<input name="return" value="<?php echo home_url();?>/dashboard?page=paypal_success&software=tier2&referer=<?php echo $refrer_detail->username;?>&amount=200" type="hidden">
								<input name="rm" value="1" type="hidden">
								<input name="currency_code" value="USD" type="hidden">
								<input name="handling_cart" value="0.00" type="hidden">
								<input name="invoice" value="2-2c7a76c0680992ab08c3be1118685463" type="hidden">
				...
				<div id="collapseThree1" class="panel-collapse collapse <?php if($refrer_detail->arb_login_key == "" && $refrer_detail->paypal_email_id == ""){ echo "in"; }?>" role="tabpanel" aria-labelledby="headingThree">
					<div class="panel-body">
					<form action="<?php echo home_url();?>/dashboard/?page=tier2&payment=payeezy" method="post" id="payeezy_all">
					<div class="row">
						<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
							<div class="form-group">
								<label for="cardNumber">Card Holder Name</label>
				...
				if($refrer_detail->stripe_secret != '') { ?>
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingThree">
							...
							<label for='r13' style='width: 100%;margin-bottom:0px;'>
							<!-- <input type='radio' id='r13' name='occupation' value='Not-Working' required <?php if($refrer_detail->arb_login_key == "" && $refrer_detail->paypal_email_id == ""){ echo "checked"; }?>/> -->
							<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThreefull2_ref" aria-expanded="false" aria-controls="collapseThree">
								Stripe
							</a>
							</h4>
						</div>
						<div id="collapseThreefull2_ref" class="panel-collapse collapse <?php if($refrer_detail->arb_login_key == "" && $refrer_detail->paypal_email_id == ""){ echo "in"; }?>" role="tabpanel" aria-labelledby="headingThree">
							<div class="panel-body">					
							  	<div class="row">	
...
<div class="modal fade" id="paymentMethod_tier2_admin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		...
		<div class="payment-popup">
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="panel-heading" role="tab" id="headingOne">
					...
					<label for='r11' style='width: 100%;margin-bottom:0px;'>
					<!--  <input type='radio' id='r11' name='occupation' value='Working' checked required /> -->
					<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOnetier2admin" aria-expanded="true" aria-controls="collapseOnetier2">
						Authorize.net <span class="payment-image pull-right"><img src="<?php echo home_url().'/wp-content/themes/Divi-child/admin/profile_image/'?>visa.png" alt="Visa" /> <img src="<?php echo home_url().'/wp-content/themes/Divi-child/admin/profile_image/'?>mastercard.png" alt="Visa" /></span>
					</a>
					</h4>
				</div>
				<div id="collapseOnetier2admin" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
					<form action="<?php echo home_url();?>/dashboard/?page=tier2&payment=authorize&role=admin" method="post" id="all_auth_form">
					<div class="row">
						<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
						...
						<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
							<div class="form-group">
								<label for="exampleInputEmail1">Amount to be paid</label>
								<input type="text" class="form-control" name="amount_auth" placeholder="Amount" readonly value="$50" />
							</div>
						</div>
						<input type="hidden" name="software" value="tier2">
						<input type="hidden" name="referer" value="<?php echo $admin_details->username;?>">
						...
						<div class="col-md-5 col-sm-5 col-lg-5 col-xs-12">
							<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                    <div class="input-group-addon">$</div>
                                    <input name="amount_1" value="50.00" type="text" readonly class="form-control" placeholder="Amount" />
                                    </div>
                                </div>
                                </div>
									</br>
				...
				<div id="collapseThree1admin" class="panel-collapse collapse <?php if($admin_details->arb_login_key == "" && $admin_details->paypal_email_id == ""){ echo "in"; }?>" role="tabpanel" aria-labelledby="headingThree">
					...
					<div class="row">
						...
						<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
							<div class="form-group">
							<label for="exampleInputEmail1">Amount to be paid</label>
								<input type="text" class="form-control" name="amount" placeholder="50" readonly value="$50">																
								<input type="hidden" name="referer" value="<?php echo $admin_details->username;?>">
							</div>
						</div>
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 text-center">
							  	...
							  	<div class="row">	
									<form action="<?php echo home_url();?>/dashboard/?page=tier1&payment=stripe&role=admin" method="post">
										<script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
												...
												data-amount="5000"
												data-locale="auto"></script>
												<input type="hidden" class="form-control" name="amount" placeholder="40" readonly value="50">
												<input type="hidden" name="software" value="tier2">
												<input type="hidden" name="referer" value="<?php echo $admin_details->username;?>">
									</form>					
								</div>					
...
<div class="modal fade" id="paymentMethod_tier2_my" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		...
		<div class="payment-popup">
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="panel-heading" role="tab" id="headingOne">
					...
					<label for='r11' style='width: 100%;margin-bottom:0px;'>
					<!--  <input type='radio' id='r11' name='occupation' value='Working' checked required /> -->
					<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOnetier2my" aria-expanded="true" aria-controls="collapseOnetier2">
						Authorize.net <span class="payment-image pull-right"><img src="<?php echo home_url().'/wp-content/themes/Divi-child/admin/profile_image/'?>visa.png" alt="Visa" /> <img src="<?php echo home_url().'/wp-content/themes/Divi-child/admin/profile_image/'?>mastercard.png" alt="Visa" /></span>
					</a>
					</h4>
				</div>
				<div id="collapseOnetier2my" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
					<form action="<?php echo home_url();?>/dashboard/?page=tier2&payment=authorize" method="post" id="all_auth_form">
					<div class="row">
						<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
						...
						<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
							<div class="form-group">
								<label for="exampleInputEmail1">Amount to be paid</label>
								<input type="text" class="form-control" name="amount_auth" placeholder="Amount" readonly value="$100" />
							</div>
						</div>
						<input type="hidden" name="software" value="tier2">
						<input type="hidden" name="referer" value="<?php echo $refrer_detail->username;?>">
					...
					<div class="row">
						<div class="col-md-5 col-sm-5 col-lg-5 col-xs-12">
							<div class="form-group">
								...
								<input name="no_shipping" value="1" type="hidden">
								<!-- sucecess url -->
								<input name="return" value="<?php echo home_url();?>/dashboard?page=paypal_success&software=tier2&referer=<?php echo $refrer_detail->username;?>&amount=20" type="hidden">
								<input name="rm" value="1" type="hidden">
								<input name="currency_code" value="USD" type="hidden">
								<input name="handling_cart" value="0.00" type="hidden">
								<input name="invoice" value="2-2c7a76c0680992ab08c3be1118685463" type="hidden">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                    <div class="input-group-addon">$</div>
                                    <input name="amount_1" value="100.00" readonly type="text" class="form-control" placeholder="Amount" />
                                    </div>
                                </div>
                                </div>
									</br>
				...
				<div id="collapseThree1my" class="panel-collapse collapse <?php if($refrer_detail->arb_login_key == "" && $refrer_detail->paypal_email_id == ""){ echo "in"; }?>" role="tabpanel" aria-labelledby="headingThree">
					...
					<div class="row">
						...
						<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
							<div class="form-group">
							<label for="exampleInputEmail1">Amount to be paid</label>
								<input type="text" class="form-control" name="amount" placeholder="200" readonly value="$100">
								<input type="hidden" name="referer" value="<?php echo $refrer_detail->username;?>">															
							</div>
						</div>
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 text-center">
							...
							<div class="panel-body">					
									...
									<form action="<?php echo home_url();?>/dashboard/?page=tier1&payment=stripe" method="post">
										<script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
												...
												data-amount="10000"
												data-locale="auto"></script>
												<input type="hidden" class="form-control" name="amount" placeholder="40" readonly value="100">
												<input type="hidden" name="software" value="tier2">
												<input type="hidden" name="referer" value="<?php echo $refrer_detail->username;?>">
									</form>					
								</div>					
...
<div class="modal fade" id="paymentMethod_tier2_his" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		...
		<div class="payment-popup">
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="panel-heading" role="tab" id="headingOne">
					...
					<label for='r11' style='width: 100%;margin-bottom:0px;'>
					<!--  <input type='radio' id='r11' name='occupation' value='Working' checked required /> -->
					<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOnetier2his" aria-expanded="true" aria-controls="collapseOnetier2">
						Authorize.net <span class="payment-image pull-right"><img src="<?php echo home_url().'/wp-content/themes/Divi-child/admin/profile_image/'?>visa.png" alt="Visa" /> <img src="<?php echo home_url().'/wp-content/themes/Divi-child/admin/profile_image/'?>mastercard.png" alt="Visa" /></span>
					</a>
					</h4>
				</div>
				<div id="collapseOnetier2his" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
					<form action="<?php echo home_url();?>/dashboard/?page=tier2&payment=authorize" method="post" id="all_auth_form">
					<div class="row">
						<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
						...
						<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
							<div class="form-group">
								<label for="exampleInputEmail1">Amount to be paid</label>
								<input type="text" class="form-control" name="amount_auth" placeholder="Amount" readonly value="$150" />
							</div>
						</div>
						<input type="hidden" name="software" value="tier2">
					...
					<div class="row">
						<div class="col-md-5 col-sm-5 col-lg-5 col-xs-12">
							<div class="form-group">
								...
								<input name="return" value="<?php echo home_url();?>/dashboard?page=paypal_success&software=tier2&referer=<?php echo $his_refrer_detail->username;?>&amount=20" type="hidden">
								<input name="rm" value="1" type="hidden">
								<input name="currency_code" value="USD" type="hidden">
								<input name="handling_cart" value="0.00" type="hidden">
								<input name="invoice" value="2-2c7a76c0680992ab08c3be1118685463" type="hidden">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                    <div class="input-group-addon">$</div>
                                    <input name="amount_1" readonly value="150.00" type="text" class="form-control" placeholder="Amount" />
                                    </div>
                                </div>
                                </div>
									</br>
				...
				<div id="collapseThree1his" class="panel-collapse collapse <?php if($his_refrer_detail->arb_login_key == "" && $his_refrer_detail->paypal_email_id == ""){ echo "in"; }?>" role="tabpanel" aria-labelledby="headingThree">
					...
					<div class="row">
						...
						<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
							<div class="form-group">
							<label for="exampleInputEmail1">Amount to be paid</label>
								<input type="text" class="form-control" name="amount" placeholder="150" readonly value="$150">								
							</div>
						</div>
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 text-center">
							<div class="form-group">
				...
				<?php } 
				if($his_refrer_detail->stripe_secret != '') { ?>
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingThree">
							<h4 class="panel-title">
							<label for='r13' style='width: 100%;margin-bottom:0px;'>
							<!-- <input type='radio' id='r13' name='occupation' value='Not-Working' required <?php if($his_refrer_detail->arb_login_key == "" && $his_refrer_detail->paypal_email_id == ""){ echo "checked"; }?>/> -->
							<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree2_his" aria-expanded="false" aria-controls="collapseThree">
								Stripe
							</a>
							</h4>
						</div>
						<div id="collapseThree2_his" class="panel-collapse collapse <?php if($his_refrer_detail->arb_login_key == "" && $his_refrer_detail->paypal_email_id == ""){ echo "in"; }?>" role="tabpanel" aria-labelledby="headingThree">
							<div class="panel-body">					
									<div class="row">	
									<form action="<?php echo home_url();?>/dashboard/?page=tier1&payment=stripe" method="post">
										<script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
												...
												data-amount="15000"
												data-locale="auto"></script>
												<input type="hidden" class="form-control" name="amount" placeholder="40" readonly value="150">
												<input type="hidden" name="software" value="tier2">
												<input type="hidden" name="referer" value="<?php echo $his_refrer_detail->username;?>">
									</form>					
								</div>					
				...
				<?php } if($his_refrer_detail->arb_login_key == null && $his_refrer_detail->paypal_email_id == null ){ echo "<h4 class='text-center' style='color:red;'>No Payment is selected from ".ucwords($his_refrer_detail->refrencename)."</h4>"; ?>
...
<!-- this is my referer $50 payment -->
<div class="modal fade" id="paymentMethod_tier2_his_half" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		...
		<div class="payment-popup">
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="panel-heading" role="tab" id="headingOne">
					...
					<label for='r11' style='width: 100%;margin-bottom:0px;'>
					<!--  <input type='radio' id='r11' name='occupation' value='Working' checked required /> -->
					<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOnetier250his" aria-expanded="true" aria-controls="collapseOnetier2">
						Authorize.net <span class="payment-image pull-right"><img src="<?php echo home_url().'/wp-content/themes/Divi-child/admin/profile_image/'?>visa.png" alt="Visa" /> <img src="<?php echo home_url().'/wp-content/themes/Divi-child/admin/profile_image/'?>mastercard.png" alt="Visa" /></span>
					</a>
					</h4>
				</div>
				<div id="collapseOnetier250his" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
					<form action="<?php echo home_url();?>/dashboard/?page=tier2&payment=authorize" method="post" id="all_auth_form">
					<div class="row">
						<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
				...
				<div class="panel-heading" role="tab" id="headingTwo">
					...
					<label for='r12' style='width: 100%;margin-bottom:0px;'>
					<!-- <input type='radio' id='r12' name='occupation' value='Not-Working' required <?php if($his_refrer_detail->arb_login_key == "" && $his_refrer_detail->hmac_key == ""){ echo "checked"; }?>/> -->
					<a for="optionsRadios1" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo501his" aria-expanded="false" aria-controls="collapseTwo">
						Paypal <span class="payment-image pull-right"><img src="<?php echo home_url();?>/wp-content/themes/Divi-child/admin/profile_image/paypal.png" alt="Visa" /></span>
					</a>
					</h4>
				</div>
				<div id="collapseTwo501his" class="panel-collapse collapse <?php if($refrer_detail->arb_login_key == "" && $refrer_detail->hmac_key == ""){ echo "in"; }?>" role="tabpanel" aria-labelledby="headingTwo">
					<div class="panel-body">
					<div class="row">
						<div class="col-md-5 col-sm-5 col-lg-5 col-xs-12">
							<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                    <div class="input-group-addon">$</div>
                                    <input name="amount_1" readonly value="50.00" type="text" class="form-control" placeholder="Amount" />
                                    </div>
                                </div>
                                </div>
									</br>
				...
				<div class="panel-heading" role="tab" id="headingThree">
					...
					<label for='r13' style='width: 100%;margin-bottom:0px;'>
					<!-- <input type='radio' id='r13' name='occupation' value='Not-Working' required <?php if($his_refrer_detail->arb_login_key == "" && $his_refrer_detail->paypal_email_id == ""){ echo "checked"; }?>/> -->
					<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree501his" aria-expanded="false" aria-controls="collapseThree">
						Payezy
					</a>
					</h4>
				</div>
				<div id="collapseThree501his" class="panel-collapse collapse <?php if($his_refrer_detail->arb_login_key == "" && $his_refrer_detail->paypal_email_id == ""){ echo "in"; }?>" role="tabpanel" aria-labelledby="headingThree">
					<div class="panel-body">
					<form action="<?php echo home_url();?>/dashboard/?page=tier2&payment=payeezy" method="post" id="payeezy_all">
					<div class="row">
						<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
						...
						<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
							<div class="form-group">
							<label for="exampleInputEmail1">Amount to be paid</label>
								<input type="text" class="form-control" name="amount" placeholder="150" readonly value="$50">	
							</div>
						</div>
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 text-center">
							<div class="form-group">
				...
				if($his_refrer_detail->stripe_secret != '') { ?>
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingThree">
							...
							<label for='r13' style='width: 100%;margin-bottom:0px;'>
							<!-- <input type='radio' id='r13' name='occupation' value='Not-Working' required <?php if($his_refrer_detail->arb_login_key == "" && $his_refrer_detail->paypal_email_id == ""){ echo "checked"; }?>/> -->
							<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree52_his" aria-expanded="false" aria-controls="collapseThree">
								Stripe
							</a>
							</h4>
						</div>
						<div id="collapseThree52_his" class="panel-collapse collapse <?php if($his_refrer_detail->arb_login_key == "" && $his_refrer_detail->paypal_email_id == ""){ echo "in"; }?>" role="tabpanel" aria-labelledby="headingThree">
							<div class="panel-body">					
									<div class="row">	
									<form action="<?php echo home_url();?>/dashboard/?page=tier1&payment=stripe" method="post">
										<script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
