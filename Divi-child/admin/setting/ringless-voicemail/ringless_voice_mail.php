					...
					<div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">
						...
						<div class="dashboard-short">
							<div class="row">
								...
								<div class="col-md-4 col-sm-4 col-lg-4 col-xs-12">
								<?php
								$campaign_value = $wpdb->get_row("SELECT * FROM $table_name WHERE id = 6",ARRAY_A);
								
								if($campaign_value['slybroadcast_uniqueid'] == ''){
								
								?>
									<a href="javscript:void(0)" data-toggle="modal" data-target="#exampleModalLong">
								<?php	} 
								else{
								echo '<a href="'.home_url().'/dashboard/?page=ringless_voice_mail&sub-page=compaigns">';
								}
								?>
