                       ...
                       <div class="setting-divs campaign-page">
                              ...
                              <span class="label label-danger">No space or special characters permitted in  keyword</span>
													  ...
													  <div class="form-group">
														...
														<div class="col-sm-7 col-md-7 col-lg-7 col-xs-12">
														  <textarea class="form-control" name="sms_camp_sms" maxlength="160" id="sms_campaign_sms"></textarea>
														  ...
														  <div class="mobilehidden-div" id="mobilehidden-div">
															<div class="form-group">
															  ...
															  <div class="form-group">
																...
																<div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
																  <textarea type="phone" class="form-control" name="sms_camp_lead_nitification" id="sms_lead_text"maxlength=160></textarea>
															...
															<div class="row">
																		...
																		<div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
																		  <ul class="list-inline day-ul">
																			<li>
                                                                                ...
                                                                                ?>
																					<option value="<?php echo $day;?>"><?php echo $day;?> Day(s)</option>
                                                                                    <?php
																...
																<div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
																	<div class="form-group">
																		...
																		<div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
																		  <input type="text" name="time_sms" name="sms_followup_time" id="time_sms">
																		</div>
																	</div>
																</div>
															</div>
															  <div class="form-group">
																...
																<div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
																  <textarea type="phone" class="form-control" name="sms_followup_sms_text" id="sms_below_text" maxlength="160"></textarea>
